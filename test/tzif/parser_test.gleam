...
pub fn new_york_header_test() {
  ...
  assert tzdata.header == parser.TzFileHeader(2, 6, 6, 0, 236, 6, 20)
}
...
pub fn utc_header_test() {
  ...
  assert tzdata.header == parser.TzFileHeader(2, 0, 0, 0, 0, 1, 4)
}
...
pub fn right_utc_header_test() {
  ...
  assert tzdata.header == parser.TzFileHeader(2, 0, 0, 27, 1, 1, 4)
}
...
pub fn new_york_field_test() {
  ...
  assert tzdata.fields.ttinfos
    == [
      parser.TtInfo(-17_762, 0, 0),
      parser.TtInfo(-14_400, 1, 4),
      parser.TtInfo(-18_000, 0, 8),
      parser.TtInfo(-18_000, 0, 8),
      parser.TtInfo(-14_400, 1, 12),
      parser.TtInfo(-14_400, 1, 16),
    ]
